...
java -jar target/JavaJson-1.12-SNAPSHOT-jar-with-dependencies.jar testdata/hello.json
```
...
```shell
mvn package -DskipTests
java -jar target/JavaJson-1.12-SNAPSHOT-jar-with-dependencies.jar testdata/car_maintenance.json
```
...
```shell
mvn package -DskipTests
java -jar target/JavaJson-1.12-SNAPSHOT-jar-with-dependencies.jar testdata/sortme.json
```
