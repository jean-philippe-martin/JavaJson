...
//                }
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (args.length==1 && args[0].equals("--help")) {
            ...
            System.out.println("java -jar target/JavaJson-1.9-jar-with-dependencies.jar testdata/hello.json");
            System.out.println("java -jar target/JavaJson-1.9-jar-with-dependencies.jar testdata/hello.json --goto '.players[0].score'");
            System.out.println("java -jar target/JavaJson-1.9-jar-with-dependencies.jar testdata/hello.json --print '.players[*].name'");
            System.out.println();
